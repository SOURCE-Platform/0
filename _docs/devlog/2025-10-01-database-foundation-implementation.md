...
- `src-tauri/src/core/database.rs` (new)
- `src-tauri/src/core/mod.rs` (new)
- `src-tauri/src/lib.rs`
- `src-tauri/migrations/20251001000001_create_sessions_table.sql` (new)
- `src-tauri/migrations/20251001000002_create_consent_records_table.sql` (new)
